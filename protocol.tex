...
\item Round counters $\schedround$ for the scheduling protocol and $r$ for the normal communication rounds. Counters start with $0$ and get incremented as specified below.
