...
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_logging, (int level, const char* file, int line, const char* msg));
#endif
...
sgx_status_t ecall_scheduling(sgx_enclave_id_t eid, int* retval, const void* _prev_msg, void* _state, void* _new_msg);
sgx_status_t ecall_aggregate(sgx_enclave_id_t eid, int* retval, const UserMessage_C* _message, const AggregatedMessage_C* _cur_agg, AggregatedMessage_C* _new_agg);
