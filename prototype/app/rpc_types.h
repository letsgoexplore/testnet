...
inline void rpc_type_to_enclave_type(AggregatedMessage& new_agg, const rpc::Aggregation& agg) {
...
inline void enclave_type_to_rpc_type(rpc::Aggregation* agg, const AggregatedMessage& agg_msg) {
  agg->set_current_aggregated_value(agg_msg.current_aggregated_value._msg.to_string());
...
inline void rpc_type_to_enclave_type(UserMessage& new_msg, const rpc::UserMessage& msg) {
