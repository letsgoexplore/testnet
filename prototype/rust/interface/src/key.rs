...
use sgx_types::{SGX_ECP256_KEY_SIZE, SGX_NISTP_ECP256_KEY_SIZE, SGX_HMAC256_KEY_SIZE,
                sgx_ec256_private_t, sgx_ec256_public_t, sgx_ec256_signature_t};
...
impl Into<sgx_ec256_public_t> for PubKey {
    fn into(self) -> sgx_ec256_public_t {
        sgx_ec256_public_t {gx: self.gx, gy: self.gy}
    }
}
